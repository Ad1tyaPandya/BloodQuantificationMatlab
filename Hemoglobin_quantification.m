...
% cuffed
%%%%%%%%%%%%%%%%%%%%%%%%%
video_650 = 'F:\ZWH\2D_PPG_Computer_Science_project\Huining_code\Hemoglobin_quantification\11052021_650_950nm_Chuqin\11052021_650_950nm_Chuqin_cuffed\20211105_Chuqin_650_cuffed_1.avi';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%
Image_950 = 'F:\ZWH\2D_PPG_Computer_Science_project\Huining_code\Hemoglobin_quantification\11052021_650_950nm_Chuqin\11052021_650_950nm_Chuqin_cuffed\20211105_Chuqin_950_cuffed_1.avi';
...
% uncuffed
%%%%%%%%%%%%%%%%%%%%%%%%%
video_650 = 'F:\ZWH\2D_PPG_Computer_Science_project\Huining_code\Hemoglobin_quantification\11052021_650_950nm_Chuqin\11052021_650_950nm_Chuqin_uncuffed\20211105_Chuqin_650_uncuffed_1.avi';
...
%%%%%%%%%%%%%%%%%%%%%%%%%
Image_950 = 'F:\ZWH\2D_PPG_Computer_Science_project\Huining_code\Hemoglobin_quantification\11052021_650_950nm_Chuqin\11052021_650_950nm_Chuqin_uncuffed\20211105_Chuqin_950_uncuffed_1.avi';
...
% cuffed
 ...
 figure;imagesc(C_HbO2_cuffed);title('Oxy-hemoglobin distribution cuffed');colorbar();
    saveas(gcf,['Oxy-hemoglobin distribution cuffed.png']);
 ...
 C_Hb_cuffed(Mask_650_cuffed==0)=0;
  ...
  figure;imagesc(C_Hb_cuffed); title('Deoxy-hemoglobin distribution cuffed');colorbar();
    saveas(gcf,['Deoxy-hemoglobin distribution cuffed.png']);
...
% uncuffed
 ...
 figure;imagesc(C_HbO2_uncuffed);title('Oxy-hemoglobin distribution uncuffed');colorbar();
    saveas(gcf,['Oxy-hemoglobin distribution uncuffed.png']);
 ...
 C_Hb_uncuffed(Mask_650_cuffed==0)=0;
  ...
  figure;imagesc(C_Hb_uncuffed); title('Deoxy-hemoglobin distribution uncuffed');colorbar();
    saveas(gcf,['Deoxy-hemoglobin distribution uncuffed.png']);